...
# usage: cd ${GOPATH}/src/github.com/mqhack/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/mqhack/gopsutil/|"github.com/mqhack/gopsutil/v3/|g' @
